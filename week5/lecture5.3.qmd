...
![A classed color scale with 5 binned colors ranging from dark green on the left to dark red on the right.](https://samanthacsik.github.io/EDS-240-data-viz/slides/images/week5/classed.png){alt="A classed color scale with 5 binned colors ranging from dark green on the left to dark red on the right." width="392"}
